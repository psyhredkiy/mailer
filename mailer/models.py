...
class Job(models.Model):
    ...
    recips = models.CharField(max_length=150,verbose_name='Получатели')
    subj = models.CharField(max_length=140,verbose_name='Тема письма' )
    body = models.CharField(max_length=150,verbose_name='Текст письма')
